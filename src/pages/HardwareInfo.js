              ...
              <Row>
                ...
                <Col>
                  <h3 style={{ textAlign: "center" }}>
                    <CountUp end={this.props.info.all_time} />
                  </h3>
          ...
          <Row className="margin-card">
            <Card style={cardStyle}>
              <Row>
                ...
                <Col>
                  <h3 style={{ textAlign: "center" }}>
                    <CountUp end={this.props.info.today} />
                  </h3>
                  <h6 style={{ textAlign: "center" }}>
                    Total Devices Registered Today
                  </h6>
                </Col>
              </Row>
            </Card>
          ...
          <Row className="margin-card">
            <Card style={cardStyle}>
              <Row>
                ...
                <Col>
                  <h3 style={{ textAlign: "center" }}>
                    <CountUp end={this.props.info.by_you.all_time} />
                  </h3>
                  <h6 style={{ textAlign: "center" }}>
                    Total Devices You Registered{" "}
                  </h6>
                </Col>
              </Row>
            </Card>
          ...
          <Row className="margin-card">
            <Card style={cardStyle}>
              <Row>
                ...
                <Col>
                  <h3 style={{ textAlign: "center" }}>
                    <CountUp end={this.props.info.by_you.today} />
                  </h3>
                  <h6 style={{ textAlign: "center" }}>
                    Devices You Registered Today
                  </h6>
                </Col>
              </Row>
            </Card>
