...
import { Form, Button, ButtonToolbar, Table, Modal, InputGroup, FormControl, Spinner, Toast } from 'react-bootstrap';
...
class Profile extends Component {
    ...
    updateUserPassword = (e) => {
        ...
        let accessToken = this.props.credentials.tokens.accessToken;
        let { password, userInfo, progress } = this.state;
        ...
        if (newPassword === confirmNewPassword) {
            ...
            $.ajax({
                ...
                success: (resp) => {
                    ...
                    this.setState({ ...this.state, progress, changepasswordModalShow: false });
                                        ...
                                        >
                                            <Form onSubmit={this.updateUserInfo}>
                                                ...
                                                <Modal.Footer>
                                                    ...
                                                    <Button variant="outline-success" type="submit" disabled={ this.state.progress.edit }>{ this.getProfileEditBtnText() }</Button>
                                                </Modal.Footer>
                                            </Form>
                                        </Modal>
                                    </ButtonToolbar>
                                        ...
                                        >
                                            <Form onSubmit={this.updateUserPassword}>
                                                ...
                                                <Modal.Footer>
                                                    ...
                                                    <Button variant="outline-success" type="submit" disabled={ this.state.progress.delete }>{ this.getPasswordEditBtnText() }</Button>
                                                </Modal.Footer>
                                            </Form>
                                        </Modal>
                                    </ButtonToolbar>
